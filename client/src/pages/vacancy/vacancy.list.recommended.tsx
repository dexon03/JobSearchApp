...
import { useGetRecommendedVacanciesQuery, useLazyGetVacancyCategoriesQuery, useLazyGetVacancyLocationQuery, useLazyGetVacancySkillsQuery } from "../../app/features/vacancy/vacancy.api.ts";
...
export function VacancyListRecommendedPage() {
    const { role } = useRole();
    ...
    const { data, isLoading, refetch } = useGetRecommendedVacanciesQuery({ page, pageSize, searchTerm: searchValue, attendanceMode: filterAttendance, experience: filterExperience, location: filterLocation, skill: filterSkill, category: filterCategory });
